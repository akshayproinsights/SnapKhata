...
class PostgrestTransformBuilder<T> extends RawPostgrestBuilder<T, T, T> {
  ...
  PostgrestTransformBuilder<PostgrestList> select([String columns = '*']) {
    ...
    return PostgrestTransformBuilder<PostgrestList>(
      _copyWithType<PostgrestList, PostgrestList, PostgrestList>(
        url: url,
        headers: newHeaders,
      ),
    );
  ...
  PostgrestTransformBuilder<PostgrestMap> single() {
    ...
    return PostgrestTransformBuilder<PostgrestMap>(
      _copyWithType<PostgrestMap, PostgrestMap, PostgrestMap>(
        headers: newHeaders,
      ),
    );
  }
  ...
  PostgrestTransformBuilder<String> csv() {
    ...
    return PostgrestTransformBuilder<String>(
      _copyWithType<String, String, String>(
        headers: newHeaders,
      ),
    );
  }
  ...
  ResponsePostgrestBuilder<PostgrestResponse<T>, T, T> count(
    ...
    return ResponsePostgrestBuilder<PostgrestResponse<T>, T, T>(
      _copyWithType<PostgrestResponse<T>, T, T>(count: count),
    );
  }
  ...
  PostgrestBuilder<void, void, void> head() {
    return _copyWithType<void, void, void>(method: METHOD_HEAD);
  }
  ...
  ResponsePostgrestBuilder<Map<String, dynamic>, Map<String, dynamic>,
    ...
    return ResponsePostgrestBuilder<Map<String, dynamic>, Map<String, dynamic>,
        Map<String, dynamic>>(
      _copyWithType<Map<String, dynamic>, Map<String, dynamic>,
  ...
  PostgrestBuilder<String, String, String> explain({
    ...
    return _copyWithType<String, String, String>(headers: newHeaders);
  }
}
